      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form name="form1" action="" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select class="span11" name="unit">
                    ...
                    {
                      ?>
                      <option <?php if($row["unit"]==$company_name){echo "selected";} ?>> 
                      <?php 
                        echo $row["unit"];
                        echo "</optiion>";
                    }
            ...
            <strong>Denied!</strong> Product already exists
            </div>
...
<?php
 if(isset($_POST["submit1"]))
 {
    ...
    if($count>0)
    {
        ...
        mysqli_query($link,"update products set company_name='$_POST[companyname]', product_name='$_POST[product_name]', unit='$_POST[unit]', packing_size='$_POST[packing_size]' where id=$id") or die(mysqli_error($link));
        ?>
        <script type="text/javascript">
